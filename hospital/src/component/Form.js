...
const Form = () => {
        ...
        if (isConfirmed) {
            if(formData.contact.length === 10){
                if(formData.age >=0 && formData.age <= 110){
                    axios.post('https://hospital-web-app-2j3t.vercel.app/reports', formData)
                        .then(res => {
  ...
  return (
    <div>
        ...
        max="1000000" step="0.01" name="WBC" onChange={handleChange} />
                                </div>
                                <div className="fields-all2">
                                    <label>Red Blood Cell</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="RBC" onChange={handleChange} />
                                </div>
                                <div className="fields-all2">
                                    <label>Hemoglobin</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Hemoglobin" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Mean Corpuscular Volume(MCV)</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="MCV" onChange={handleChange} />
                                </div>
                                <div className="fields-all2">
                                    <label>Mean Corpuscular Hemoglobin(MCH)</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="MCH" onChange={handleChange} />
                                </div>
                                <div className="fields-all2">
                                    <label>Haemotocrit</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Haemotocrit" onChange={handleChange}/>
                                </div>  
                                <div className="fields-all2">
                                    <label>Mean Corpuscular Hemoglobin Concentration</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="MCHC" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Red Cell Distribution Width</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="RDW" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Paltelet Count</label>
                                    <input type="number" min="0" 
        max="1000000" step="0.01" name="Paltelet" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Mean Platelet Volume(MPV)</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="MPV" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Neutrophils</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Neutrophils" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Lymphocytes</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Lymphocytes" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Monocytes</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Monocytes" onChange={handleChange}/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="reports2">
                            ...
                            <div className="report-fields2">
                                ...
                                <div className="fields-all2">
                                    <label>Sodium</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Sodium" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Pottasium</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Pottasium" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Chloride</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Chloride" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Bicarbonate</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Bicarbonate" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Calcium</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Calcium" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Phosphorus</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Phosphorus" onChange={handleChange}/>
                                </div>
                            </div>
                        ...
                        <div className="reports2">
                            ...
                            <div className="report-fields2">
                                ...
                                <div className="fields-all2">
                                    ...
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Total_Bilirubin" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Direct Bilirubin</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Direct_Bilirubin" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Indirect Bilirubin</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Indirect_Bilirubin" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>SGOT</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="SGOT" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>SGPT</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="SGPT" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Alkaline Phosphate</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Alkaline_Phosphate" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Total Protein</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Total_Protein" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Albumin</label>
                                    <input type="number" min="0" 
                        ...
                        <div className="reports2">
                            ...
                            <div className="report-fields2">
                                ...
                                <div className="fields-all2">
                                    ...
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Total_Cholestrol" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Triglycerides</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Triglycerides" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>LDL Cholestrol</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="LDL_Cholestrol" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>HDL Cholestrol</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="HDL_Cholestrol" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Non-HDL Cholestrol</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Non_HDL_Cholestrol" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                        ...
                        <div className="reports2">
                            ...
                            <div className="report-fields2">
                                ...
                                <div className="fields-all2">
                                    ...
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Fasting_Blood_Sugar" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Post-Prandial Blood</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Post_Prandial_Blood" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>Random Blood Sugar</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="Random_Blood_Sugar" onChange={handleChange}/>
                                </div>
                                <div className="fields-all2">
                                    <label>HBA1C</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01" name="HABC" onChange={handleChange}/>
                                </div>
                                {/* <div className="fields-all2">
                                    <label>CPR</label>
                                    <input type="number" min="0" 
                        ...
                        <div className="reports2">
                            ...
                            <div className="report-fields">
                                ...
                                <div className="fields-all">
                                    ...
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Blood_Area" onChange={handleChange}/>
                                </div>
                                <div className="fields-all">
                                    <label>Serum Creatinine</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Serum_Creatinine" onChange={handleChange}/>
                                </div>
                                <div className="fields-all">
                                    <label>Serum Uric acid</label>
                                    <input type="number" min="0" 
        max="5000" step="0.01"name="Serum_Uricacid" onChange={handleChange}/>
                                </div>
                            </div>
                        </div>
                        <div className="reports2">
